...
print(f'The sum of two float numbers({number_1} and {number_2}) is {sum_float_numbers}.')
...
print(f'The average number between the two float numbers ({number_1} and {number_2}) is {average_float_numbers}.')
...
print(f'The celsius temperature {celsius_temperature} is equivalent to {fahrenheit_temperature} Farenheit.')
